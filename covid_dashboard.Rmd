...
labs <- lapply(seq(nrow(college_location_final)), function(i){
  paste0('<p>', college_location_final[i, "college"], '<p></p>', "Total Cases: ",
         college_location_final[i, "cases"], '</p>')
})
    ...
    leaflet(college_location_final) %>% 
      ...
      addCircles(data = college_location_final, 
                 ...
                 label = lapply(labs, htmltools::HTML),
                   #HTML(paste0("<p>", college_location_final$college, ", ", "</p> Cases: ", college_location_final$cases)), 
