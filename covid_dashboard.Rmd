...
leafletOutput(outputId = "mymap", width = 1200, height = 1000), 
 ...
 #create the map
  output$mymap <- renderLeaflet({
    leaflet(college_location_final) %>% 
      setView(lng = -99, lat = 12, zoom = 3.5)  %>% #setting the view over ~ center of North America
      addTiles() %>% 
...
For the **South Carolina Density Plot,** Clemson University had the greatest number of COVID-19 positive cases of November 30, 2020 (date of data collection). Therefore, we assigned the number of cases per county in South Carolina. The top 3 universities in South Carolina are highlighted.
