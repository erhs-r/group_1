...
college_location_final$cases_type <- ifelse(college_location_final$cases <= 100, "low (< 100)", ifelse(college_location_final$cases <= 500, "moderate (100-500)", ifelse(college_location_final$cases > 500, "severe (> 500)", "NA")))
